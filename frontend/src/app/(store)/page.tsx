...
/**
 * Temporary storefront landing. Renders a small static product grid so the app
 * builds and shows the chrome end-to-end. The real catalog (RTK Query-driven)
 * replaces this in a later module — this demo data is intentionally inline.
 */
